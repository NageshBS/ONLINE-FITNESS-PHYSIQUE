...
app.post('/pur1',function(req,res){
	var data = { 
		"Course purchased":"Class Packages", 
		"Cost":"Rs.2100",
	...
	db.collection('purchase').insertOne(data,function(err, collection){ 
		if (err) throw err; 
		console.log("Class Packages inserted Successfully"); 	
	});
...
app.post('/pur2',function(req,res){
	var data = { 
		"Course purchased":"Term membership", 
		"Cost":"Rs.3500",
	...
	db.collection('purchase').insertOne(data,function(err, collection){ 
		if (err) throw err; 
		console.log("Term membership inserted Successfully"); 	
	});
...
app.post('/pur3',function(req,res){
	var data = { 
		"Course purchased":"Gold Membership", 
		"Cost":"Rs.7500", 
	...
	db.collection('purchase').insertOne(data,function(err, collection){ 
		if (err) throw err; 
		console.log("Gold Membership inserted Successfully"); 	
	});
